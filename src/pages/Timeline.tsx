...
const timelineItems = [
  ...
  },
  {
    ...
    description: "Hasta randevu süreci ve operasyonel destek süreçlerinde görev aldım. Takım liderliği deneyimi kazandım.",
    icon: PhoneCall,
    iconBg: "bg-emerald-500",
    border: "border-emerald-500/30",
    accent: "from-emerald-500/20 to-transparent",
    skills: ["İletişim", "Operasyon", "Destek", "Takım Liderliği"],
    achievements: ["Yoğun çağrı yönetimi", "Kullanıcı memnuniyeti", "Takım koordinasyonu"],
    expanded: false,
  },
  {
    id: 3,
